...
This document contains a full example of how to source and run the models to generate data. Refer to the README in the `01_model_scripts` folder for additional information on using the models, the model purpose, and model assumptions.  
